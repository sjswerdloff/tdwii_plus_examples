...
class CArmPhotonElectronRadiation:
    ...
    @property
    def TreatmentTimeLimit(self) -> Optional[float]:
        if "TreatmentTimeLimit" in self._dataset:
            return self._dataset.TreatmentTimeLimit
        return None

    @TreatmentTimeLimit.setter
    def TreatmentTimeLimit(self, value: Optional[float]):
        if value is None:
            if "TreatmentTimeLimit" in self._dataset:
                del self._dataset.TreatmentTimeLimit
        else:
            self._dataset.TreatmentTimeLimit = value
    ...
    @property
    def UserContentLabel(self) -> Optional[str]:
        if "UserContentLabel" in self._dataset:
            return self._dataset.UserContentLabel
        return None

    @UserContentLabel.setter
    def UserContentLabel(self, value: Optional[str]):
        if value is None:
            if "UserContentLabel" in self._dataset:
                del self._dataset.UserContentLabel
        else:
            self._dataset.UserContentLabel = value
