...
class EnhancedUsVolume:
    ...
    def ExcludedIntervalsSequence(self, value: Optional[List[ExcludedIntervalsSequenceItem]]):
        if value is None:
            ...
            raise ValueError("ExcludedIntervalsSequence must be a list of ExcludedIntervalsSequenceItem objects")
        else:
    ...
    def add_ExcludedIntervals(self, item: ExcludedIntervalsSequenceItem):
        if not isinstance(item, ExcludedIntervalsSequenceItem):
            raise ValueError("Item must be an instance of ExcludedIntervalsSequenceItem")
    ...
    def DataFrameAssignmentSequence(self, value: Optional[List[DataFrameAssignmentSequenceItem]]):
        if value is None:
            ...
            raise ValueError("DataFrameAssignmentSequence must be a list of DataFrameAssignmentSequenceItem objects")
        else:
    ...
    def add_DataFrameAssignment(self, item: DataFrameAssignmentSequenceItem):
        if not isinstance(item, DataFrameAssignmentSequenceItem):
            raise ValueError("Item must be an instance of DataFrameAssignmentSequenceItem")
    ...
    def BlendingLUT1Sequence(self, value: Optional[List[BlendingLUT1SequenceItem]]):
        if value is None:
            ...
            raise ValueError("BlendingLUT1Sequence must be a list of BlendingLUT1SequenceItem objects")
        else:
    ...
    def add_BlendingLUT1(self, item: BlendingLUT1SequenceItem):
        if not isinstance(item, BlendingLUT1SequenceItem):
            raise ValueError("Item must be an instance of BlendingLUT1SequenceItem")
    ...
    def EnhancedPaletteColorLookupTableSequence(self, value: Optional[List[EnhancedPaletteColorLookupTableSequenceItem]]):
        if value is None:
            ...
            raise ValueError(
                "EnhancedPaletteColorLookupTableSequence must be a list of EnhancedPaletteColorLookupTableSequenceItem objects"
            )
        else:
    ...
    def add_EnhancedPaletteColorLookupTable(self, item: EnhancedPaletteColorLookupTableSequenceItem):
        if not isinstance(item, EnhancedPaletteColorLookupTableSequenceItem):
            raise ValueError("Item must be an instance of EnhancedPaletteColorLookupTableSequenceItem")
    ...
    def BlendingLUT2Sequence(self, value: Optional[List[BlendingLUT2SequenceItem]]):
        if value is None:
            ...
            raise ValueError("BlendingLUT2Sequence must be a list of BlendingLUT2SequenceItem objects")
        else:
    ...
    def add_BlendingLUT2(self, item: BlendingLUT2SequenceItem):
        if not isinstance(item, BlendingLUT2SequenceItem):
            raise ValueError("Item must be an instance of BlendingLUT2SequenceItem")
    ...
    def EventTimerSequence(self, value: Optional[List[EventTimerSequenceItem]]):
        if value is None:
            ...
            raise ValueError("EventTimerSequence must be a list of EventTimerSequenceItem objects")
        else:
    ...
    def add_EventTimer(self, item: EventTimerSequenceItem):
        if not isinstance(item, EventTimerSequenceItem):
            raise ValueError("Item must be an instance of EventTimerSequenceItem")
    ...
    def TransducerIdentificationSequence(self, value: Optional[List[TransducerIdentificationSequenceItem]]):
        if value is None:
            ...
            raise ValueError("TransducerIdentificationSequence must be a list of TransducerIdentificationSequenceItem objects")
        else:
    ...
    def add_TransducerIdentification(self, item: TransducerIdentificationSequenceItem):
        if not isinstance(item, TransducerIdentificationSequenceItem):
            raise ValueError("Item must be an instance of TransducerIdentificationSequenceItem")
    ...
    def TransducerScanPatternCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError("TransducerScanPatternCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def TransducerGeometryCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError("TransducerGeometryCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def TransducerBeamSteeringCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError("TransducerBeamSteeringCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def TransducerApplicationCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError("TransducerApplicationCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def StageCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError("StageCodeSequence must be a list of CodeSequenceItem objects")
        else:
