...
class GeneralAccessorySequenceItem:
    ...
    @property
    def SourceToGeneralAccessoryDistance(self) -> Optional[float]:
        if "SourceToGeneralAccessoryDistance" in self._dataset:
            return self._dataset.SourceToGeneralAccessoryDistance
        return None

    @SourceToGeneralAccessoryDistance.setter
    def SourceToGeneralAccessoryDistance(self, value: Optional[float]):
        if value is None:
            if "SourceToGeneralAccessoryDistance" in self._dataset:
                del self._dataset.SourceToGeneralAccessoryDistance
        else:
            self._dataset.SourceToGeneralAccessoryDistance = value
