...
class GeneralAccessorySequenceItem:
    ...
    @property
    def IsocenterToGeneralAccessoryDistance(self) -> Optional[Decimal]:
        if "IsocenterToGeneralAccessoryDistance" in self._dataset:
            return self._dataset.IsocenterToGeneralAccessoryDistance
        return None

    @IsocenterToGeneralAccessoryDistance.setter
    def IsocenterToGeneralAccessoryDistance(self, value: Optional[Decimal]):
        if value is None:
            if "IsocenterToGeneralAccessoryDistance" in self._dataset:
                del self._dataset.IsocenterToGeneralAccessoryDistance
        else:
            self._dataset.IsocenterToGeneralAccessoryDistance = value
