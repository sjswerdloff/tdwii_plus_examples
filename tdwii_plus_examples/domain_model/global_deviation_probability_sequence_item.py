...
class GlobalDeviationProbabilitySequenceItem:
    ...
    @property
    def GlobalDeviationProbability(self) -> Optional[float]:
        if "GlobalDeviationProbability" in self._dataset:
            return self._dataset.GlobalDeviationProbability
        return None

    @GlobalDeviationProbability.setter
    def GlobalDeviationProbability(self, value: Optional[float]):
        if value is None:
            if "GlobalDeviationProbability" in self._dataset:
                del self._dataset.GlobalDeviationProbability
        else:
            self._dataset.GlobalDeviationProbability = value
