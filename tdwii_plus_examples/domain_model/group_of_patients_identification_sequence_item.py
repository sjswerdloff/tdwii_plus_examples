...
class GroupOfPatientsIdentificationSequenceItem:
    ...
    @property
    def SubjectRelativePositionInImage(self) -> Optional[List[int]]:
        if "SubjectRelativePositionInImage" in self._dataset:
            return self._dataset.SubjectRelativePositionInImage
        return None

    @SubjectRelativePositionInImage.setter
    def SubjectRelativePositionInImage(self, value: Optional[List[int]]):
        if value is None:
            if "SubjectRelativePositionInImage" in self._dataset:
                del self._dataset.SubjectRelativePositionInImage
        else:
            self._dataset.SubjectRelativePositionInImage = value
