...
class InstructionSequenceItem:
    ...
    @property
    def InstructionPerformanceComment(self) -> Optional[str]:
        if "InstructionPerformanceComment" in self._dataset:
            return self._dataset.InstructionPerformanceComment
        return None

    @InstructionPerformanceComment.setter
    def InstructionPerformanceComment(self, value: Optional[str]):
        if value is None:
            if "InstructionPerformanceComment" in self._dataset:
                del self._dataset.InstructionPerformanceComment
        else:
            self._dataset.InstructionPerformanceComment = value
