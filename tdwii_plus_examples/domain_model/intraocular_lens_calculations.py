...
from .intraocular_lens_calculations_left_eye_sequence_item import (
    IntraocularLensCalculationsLeftEyeSequenceItem,
)
from .intraocular_lens_calculations_right_eye_sequence_item import (
    IntraocularLensCalculationsRightEyeSequenceItem,
)
...
class IntraocularLensCalculations:
    def __init__(self, dataset: Optional[pydicom.Dataset] = None):
        ...
        self._IntraocularLensCalculationsRightEyeSequence: List[IntraocularLensCalculationsRightEyeSequenceItem] = []
        self._IntraocularLensCalculationsLeftEyeSequence: List[IntraocularLensCalculationsLeftEyeSequenceItem] = []
    ...
    @property
    def IntraocularLensCalculationsRightEyeSequence(self) -> Optional[List[IntraocularLensCalculationsRightEyeSequenceItem]]:
        if "IntraocularLensCalculationsRightEyeSequence" in self._dataset:
            if len(self._IntraocularLensCalculationsRightEyeSequence) == len(
                self._dataset.IntraocularLensCalculationsRightEyeSequence
            ):
                return self._IntraocularLensCalculationsRightEyeSequence
            else:
                return [
                    IntraocularLensCalculationsRightEyeSequenceItem(x)
                    for x in self._dataset.IntraocularLensCalculationsRightEyeSequence
                ]
        return None

    @IntraocularLensCalculationsRightEyeSequence.setter
    def IntraocularLensCalculationsRightEyeSequence(
        self, value: Optional[List[IntraocularLensCalculationsRightEyeSequenceItem]]
    ):
        if value is None:
            self._IntraocularLensCalculationsRightEyeSequence = []
            if "IntraocularLensCalculationsRightEyeSequence" in self._dataset:
                del self._dataset.IntraocularLensCalculationsRightEyeSequence
        elif not isinstance(value, list) or not all(
            isinstance(item, IntraocularLensCalculationsRightEyeSequenceItem) for item in value
        ):
            raise ValueError(
                f"IntraocularLensCalculationsRightEyeSequence must be a list of IntraocularLensCalculationsRightEyeSequenceItem objects"
            )
        else:
            self._IntraocularLensCalculationsRightEyeSequence = value
            if "IntraocularLensCalculationsRightEyeSequence" not in self._dataset:
                self._dataset.IntraocularLensCalculationsRightEyeSequence = pydicom.Sequence()
            self._dataset.IntraocularLensCalculationsRightEyeSequence.clear()
            self._dataset.IntraocularLensCalculationsRightEyeSequence.extend([item.to_dataset() for item in value])

    def add_IntraocularLensCalculationsRightEye(self, item: IntraocularLensCalculationsRightEyeSequenceItem):
        if not isinstance(item, IntraocularLensCalculationsRightEyeSequenceItem):
            raise ValueError(f"Item must be an instance of IntraocularLensCalculationsRightEyeSequenceItem")
        self._IntraocularLensCalculationsRightEyeSequence.append(item)
        if "IntraocularLensCalculationsRightEyeSequence" not in self._dataset:
            self._dataset.IntraocularLensCalculationsRightEyeSequence = pydicom.Sequence()
        self._dataset.IntraocularLensCalculationsRightEyeSequence.append(item.to_dataset())

    @property
    def IntraocularLensCalculationsLeftEyeSequence(self) -> Optional[List[IntraocularLensCalculationsLeftEyeSequenceItem]]:
        if "IntraocularLensCalculationsLeftEyeSequence" in self._dataset:
            if len(self._IntraocularLensCalculationsLeftEyeSequence) == len(
                self._dataset.IntraocularLensCalculationsLeftEyeSequence
            ):
                return self._IntraocularLensCalculationsLeftEyeSequence
            else:
                return [
                    IntraocularLensCalculationsLeftEyeSequenceItem(x)
                    for x in self._dataset.IntraocularLensCalculationsLeftEyeSequence
                ]
        return None

    @IntraocularLensCalculationsLeftEyeSequence.setter
    def IntraocularLensCalculationsLeftEyeSequence(
        self, value: Optional[List[IntraocularLensCalculationsLeftEyeSequenceItem]]
    ):
        if value is None:
            self._IntraocularLensCalculationsLeftEyeSequence = []
            if "IntraocularLensCalculationsLeftEyeSequence" in self._dataset:
                del self._dataset.IntraocularLensCalculationsLeftEyeSequence
        elif not isinstance(value, list) or not all(
            isinstance(item, IntraocularLensCalculationsLeftEyeSequenceItem) for item in value
        ):
            raise ValueError(
                f"IntraocularLensCalculationsLeftEyeSequence must be a list of IntraocularLensCalculationsLeftEyeSequenceItem objects"
            )
        else:
            self._IntraocularLensCalculationsLeftEyeSequence = value
            if "IntraocularLensCalculationsLeftEyeSequence" not in self._dataset:
                self._dataset.IntraocularLensCalculationsLeftEyeSequence = pydicom.Sequence()
            self._dataset.IntraocularLensCalculationsLeftEyeSequence.clear()
            self._dataset.IntraocularLensCalculationsLeftEyeSequence.extend([item.to_dataset() for item in value])

    def add_IntraocularLensCalculationsLeftEye(self, item: IntraocularLensCalculationsLeftEyeSequenceItem):
        if not isinstance(item, IntraocularLensCalculationsLeftEyeSequenceItem):
            raise ValueError(f"Item must be an instance of IntraocularLensCalculationsLeftEyeSequenceItem")
        self._IntraocularLensCalculationsLeftEyeSequence.append(item)
        if "IntraocularLensCalculationsLeftEyeSequence" not in self._dataset:
            self._dataset.IntraocularLensCalculationsLeftEyeSequence = pydicom.Sequence()
        self._dataset.IntraocularLensCalculationsLeftEyeSequence.append(item.to_dataset())
