...
class IntraocularLensCalculations:
    ...
    def IntraocularLensCalculationsRightEyeSequence(
        ...
        if value is None:
            ...
            raise ValueError(
                "IntraocularLensCalculationsRightEyeSequence must be a list of IntraocularLensCalculationsRightEyeSequenceItem"
                " objects"
            )
        else:
    ...
    def add_IntraocularLensCalculationsRightEye(self, item: IntraocularLensCalculationsRightEyeSequenceItem):
        if not isinstance(item, IntraocularLensCalculationsRightEyeSequenceItem):
            raise ValueError("Item must be an instance of IntraocularLensCalculationsRightEyeSequenceItem")
    ...
    def IntraocularLensCalculationsLeftEyeSequence(
        ...
        if value is None:
            ...
            raise ValueError(
                "IntraocularLensCalculationsLeftEyeSequence must be a list of IntraocularLensCalculationsLeftEyeSequenceItem"
                " objects"
            )
        else:
    ...
    def add_IntraocularLensCalculationsLeftEye(self, item: IntraocularLensCalculationsLeftEyeSequenceItem):
        if not isinstance(item, IntraocularLensCalculationsLeftEyeSequenceItem):
            raise ValueError("Item must be an instance of IntraocularLensCalculationsLeftEyeSequenceItem")
