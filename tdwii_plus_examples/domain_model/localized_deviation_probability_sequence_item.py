...
class LocalizedDeviationProbabilitySequenceItem:
    ...
    @property
    def LocalizedDeviationProbability(self) -> Optional[float]:
        if "LocalizedDeviationProbability" in self._dataset:
            return self._dataset.LocalizedDeviationProbability
        return None

    @LocalizedDeviationProbability.setter
    def LocalizedDeviationProbability(self, value: Optional[float]):
        if value is None:
            if "LocalizedDeviationProbability" in self._dataset:
                del self._dataset.LocalizedDeviationProbability
        else:
            self._dataset.LocalizedDeviationProbability = value
