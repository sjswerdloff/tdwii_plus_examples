...
from .ophthalmic_axial_measurements_left_eye_sequence_item import (
    OphthalmicAxialMeasurementsLeftEyeSequenceItem,
)
from .ophthalmic_axial_measurements_right_eye_sequence_item import (
...
class OphthalmicAxialMeasurements:
    def __init__(self, dataset: Optional[pydicom.Dataset] = None):
        self._dataset = dataset if dataset is not None else pydicom.Dataset()
        self._OphthalmicAxialMeasurementsRightEyeSequence: List[OphthalmicAxialMeasurementsRightEyeSequenceItem] = []
        self._OphthalmicAxialMeasurementsLeftEyeSequence: List[OphthalmicAxialMeasurementsLeftEyeSequenceItem] = []
        self._OphthalmicUltrasoundMethodCodeSequence: List[CodeSequenceItem] = []
        self._AnteriorChamberDepthDefinitionCodeSequence: List[CodeSequenceItem] = []
    ...
    @property
    def OphthalmicAxialMeasurementsRightEyeSequence(self) -> Optional[List[OphthalmicAxialMeasurementsRightEyeSequenceItem]]:
        if "OphthalmicAxialMeasurementsRightEyeSequence" in self._dataset:
            if len(self._OphthalmicAxialMeasurementsRightEyeSequence) == len(
                self._dataset.OphthalmicAxialMeasurementsRightEyeSequence
            ):
                return self._OphthalmicAxialMeasurementsRightEyeSequence
            else:
                return [
                    OphthalmicAxialMeasurementsRightEyeSequenceItem(x)
                    for x in self._dataset.OphthalmicAxialMeasurementsRightEyeSequence
                ]
        return None

    @OphthalmicAxialMeasurementsRightEyeSequence.setter
    def OphthalmicAxialMeasurementsRightEyeSequence(
        self, value: Optional[List[OphthalmicAxialMeasurementsRightEyeSequenceItem]]
    ):
        if value is None:
            self._OphthalmicAxialMeasurementsRightEyeSequence = []
            if "OphthalmicAxialMeasurementsRightEyeSequence" in self._dataset:
                del self._dataset.OphthalmicAxialMeasurementsRightEyeSequence
        elif not isinstance(value, list) or not all(
            isinstance(item, OphthalmicAxialMeasurementsRightEyeSequenceItem) for item in value
        ):
            raise ValueError(
                f"OphthalmicAxialMeasurementsRightEyeSequence must be a list of OphthalmicAxialMeasurementsRightEyeSequenceItem objects"
            )
        else:
            self._OphthalmicAxialMeasurementsRightEyeSequence = value
            if "OphthalmicAxialMeasurementsRightEyeSequence" not in self._dataset:
                self._dataset.OphthalmicAxialMeasurementsRightEyeSequence = pydicom.Sequence()
            self._dataset.OphthalmicAxialMeasurementsRightEyeSequence.clear()
            self._dataset.OphthalmicAxialMeasurementsRightEyeSequence.extend([item.to_dataset() for item in value])

    def add_OphthalmicAxialMeasurementsRightEye(self, item: OphthalmicAxialMeasurementsRightEyeSequenceItem):
        if not isinstance(item, OphthalmicAxialMeasurementsRightEyeSequenceItem):
            raise ValueError(f"Item must be an instance of OphthalmicAxialMeasurementsRightEyeSequenceItem")
        self._OphthalmicAxialMeasurementsRightEyeSequence.append(item)
        if "OphthalmicAxialMeasurementsRightEyeSequence" not in self._dataset:
            self._dataset.OphthalmicAxialMeasurementsRightEyeSequence = pydicom.Sequence()
        self._dataset.OphthalmicAxialMeasurementsRightEyeSequence.append(item.to_dataset())

    @property
    def OphthalmicAxialMeasurementsLeftEyeSequence(self) -> Optional[List[OphthalmicAxialMeasurementsLeftEyeSequenceItem]]:
        if "OphthalmicAxialMeasurementsLeftEyeSequence" in self._dataset:
            if len(self._OphthalmicAxialMeasurementsLeftEyeSequence) == len(
                self._dataset.OphthalmicAxialMeasurementsLeftEyeSequence
            ):
                return self._OphthalmicAxialMeasurementsLeftEyeSequence
            else:
                return [
                    OphthalmicAxialMeasurementsLeftEyeSequenceItem(x)
                    for x in self._dataset.OphthalmicAxialMeasurementsLeftEyeSequence
                ]
        return None

    @OphthalmicAxialMeasurementsLeftEyeSequence.setter
    def OphthalmicAxialMeasurementsLeftEyeSequence(
        self, value: Optional[List[OphthalmicAxialMeasurementsLeftEyeSequenceItem]]
    ):
        if value is None:
            self._OphthalmicAxialMeasurementsLeftEyeSequence = []
            if "OphthalmicAxialMeasurementsLeftEyeSequence" in self._dataset:
                del self._dataset.OphthalmicAxialMeasurementsLeftEyeSequence
        elif not isinstance(value, list) or not all(
            isinstance(item, OphthalmicAxialMeasurementsLeftEyeSequenceItem) for item in value
        ):
            raise ValueError(
                f"OphthalmicAxialMeasurementsLeftEyeSequence must be a list of OphthalmicAxialMeasurementsLeftEyeSequenceItem objects"
            )
        else:
            self._OphthalmicAxialMeasurementsLeftEyeSequence = value
            if "OphthalmicAxialMeasurementsLeftEyeSequence" not in self._dataset:
                self._dataset.OphthalmicAxialMeasurementsLeftEyeSequence = pydicom.Sequence()
            self._dataset.OphthalmicAxialMeasurementsLeftEyeSequence.clear()
            self._dataset.OphthalmicAxialMeasurementsLeftEyeSequence.extend([item.to_dataset() for item in value])

    def add_OphthalmicAxialMeasurementsLeftEye(self, item: OphthalmicAxialMeasurementsLeftEyeSequenceItem):
        if not isinstance(item, OphthalmicAxialMeasurementsLeftEyeSequenceItem):
            raise ValueError(f"Item must be an instance of OphthalmicAxialMeasurementsLeftEyeSequenceItem")
        self._OphthalmicAxialMeasurementsLeftEyeSequence.append(item)
        if "OphthalmicAxialMeasurementsLeftEyeSequence" not in self._dataset:
            self._dataset.OphthalmicAxialMeasurementsLeftEyeSequence = pydicom.Sequence()
        self._dataset.OphthalmicAxialMeasurementsLeftEyeSequence.append(item.to_dataset())

    @property
    def OphthalmicAxialMeasurementsDeviceType(self) -> Optional[str]:
        if "OphthalmicAxialMeasurementsDeviceType" in self._dataset:
            return self._dataset.OphthalmicAxialMeasurementsDeviceType
        return None

    @OphthalmicAxialMeasurementsDeviceType.setter
    def OphthalmicAxialMeasurementsDeviceType(self, value: Optional[str]):
        if value is None:
            if "OphthalmicAxialMeasurementsDeviceType" in self._dataset:
                del self._dataset.OphthalmicAxialMeasurementsDeviceType
        else:
            self._dataset.OphthalmicAxialMeasurementsDeviceType = value
    ...
    @property
    def AnteriorChamberDepthDefinitionCodeSequence(self) -> Optional[List[CodeSequenceItem]]:
        if "AnteriorChamberDepthDefinitionCodeSequence" in self._dataset:
            if len(self._AnteriorChamberDepthDefinitionCodeSequence) == len(
                self._dataset.AnteriorChamberDepthDefinitionCodeSequence
            ):
                return self._AnteriorChamberDepthDefinitionCodeSequence
            else:
                return [CodeSequenceItem(x) for x in self._dataset.AnteriorChamberDepthDefinitionCodeSequence]
        return None

    @AnteriorChamberDepthDefinitionCodeSequence.setter
    def AnteriorChamberDepthDefinitionCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            self._AnteriorChamberDepthDefinitionCodeSequence = []
            if "AnteriorChamberDepthDefinitionCodeSequence" in self._dataset:
                del self._dataset.AnteriorChamberDepthDefinitionCodeSequence
        elif not isinstance(value, list) or not all(isinstance(item, CodeSequenceItem) for item in value):
            raise ValueError(f"AnteriorChamberDepthDefinitionCodeSequence must be a list of CodeSequenceItem objects")
        else:
            self._AnteriorChamberDepthDefinitionCodeSequence = value
            if "AnteriorChamberDepthDefinitionCodeSequence" not in self._dataset:
                self._dataset.AnteriorChamberDepthDefinitionCodeSequence = pydicom.Sequence()
            self._dataset.AnteriorChamberDepthDefinitionCodeSequence.clear()
            self._dataset.AnteriorChamberDepthDefinitionCodeSequence.extend([item.to_dataset() for item in value])

    def add_AnteriorChamberDepthDefinitionCode(self, item: CodeSequenceItem):
        if not isinstance(item, CodeSequenceItem):
            raise ValueError(f"Item must be an instance of CodeSequenceItem")
        self._AnteriorChamberDepthDefinitionCodeSequence.append(item)
        if "AnteriorChamberDepthDefinitionCodeSequence" not in self._dataset:
            self._dataset.AnteriorChamberDepthDefinitionCodeSequence = pydicom.Sequence()
        self._dataset.AnteriorChamberDepthDefinitionCodeSequence.append(item.to_dataset())
