...
class OphthalmicAxialMeasurements:
    ...
    def OphthalmicAxialMeasurementsRightEyeSequence(
        ...
        if value is None:
            ...
            raise ValueError(
                "OphthalmicAxialMeasurementsRightEyeSequence must be a list of OphthalmicAxialMeasurementsRightEyeSequenceItem"
                " objects"
            )
        else:
    ...
    def add_OphthalmicAxialMeasurementsRightEye(self, item: OphthalmicAxialMeasurementsRightEyeSequenceItem):
        if not isinstance(item, OphthalmicAxialMeasurementsRightEyeSequenceItem):
            raise ValueError("Item must be an instance of OphthalmicAxialMeasurementsRightEyeSequenceItem")
    ...
    def OphthalmicAxialMeasurementsLeftEyeSequence(
        ...
        if value is None:
            ...
            raise ValueError(
                "OphthalmicAxialMeasurementsLeftEyeSequence must be a list of OphthalmicAxialMeasurementsLeftEyeSequenceItem"
                " objects"
            )
        else:
    ...
    def add_OphthalmicAxialMeasurementsLeftEye(self, item: OphthalmicAxialMeasurementsLeftEyeSequenceItem):
        if not isinstance(item, OphthalmicAxialMeasurementsLeftEyeSequenceItem):
            raise ValueError("Item must be an instance of OphthalmicAxialMeasurementsLeftEyeSequenceItem")
    ...
    def AnteriorChamberDepthDefinitionCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError("AnteriorChamberDepthDefinitionCodeSequence must be a list of CodeSequenceItem objects")
        else:
