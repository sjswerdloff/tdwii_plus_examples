...
from .oct_bscan_analysis_acquisition_parameters_sequence_item import (
    OCTBscanAnalysisAcquisitionParametersSequenceItem,
)
...
class OphthalmicOpticalCoherenceTomographyBScanVolumeAnalysis:
    def __init__(self, dataset: Optional[pydicom.Dataset] = None):
        ...
        self._OCTBscanAnalysisAcquisitionParametersSequence: List[OCTBscanAnalysisAcquisitionParametersSequenceItem] = []
    ...
    @property
    def OCTBscanAnalysisAcquisitionParametersSequence(
        self,
    ) -> Optional[List[OCTBscanAnalysisAcquisitionParametersSequenceItem]]:
        if "OCTBscanAnalysisAcquisitionParametersSequence" in self._dataset:
            if len(self._OCTBscanAnalysisAcquisitionParametersSequence) == len(
                self._dataset.OCTBscanAnalysisAcquisitionParametersSequence
            ):
                return self._OCTBscanAnalysisAcquisitionParametersSequence
            else:
                return [
                    OCTBscanAnalysisAcquisitionParametersSequenceItem(x)
                    for x in self._dataset.OCTBscanAnalysisAcquisitionParametersSequence
                ]
        return None

    @OCTBscanAnalysisAcquisitionParametersSequence.setter
    def OCTBscanAnalysisAcquisitionParametersSequence(
        self, value: Optional[List[OCTBscanAnalysisAcquisitionParametersSequenceItem]]
    ):
        if value is None:
            self._OCTBscanAnalysisAcquisitionParametersSequence = []
            if "OCTBscanAnalysisAcquisitionParametersSequence" in self._dataset:
                del self._dataset.OCTBscanAnalysisAcquisitionParametersSequence
        elif not isinstance(value, list) or not all(
            isinstance(item, OCTBscanAnalysisAcquisitionParametersSequenceItem) for item in value
        ):
            raise ValueError(
                f"OCTBscanAnalysisAcquisitionParametersSequence must be a list of OCTBscanAnalysisAcquisitionParametersSequenceItem objects"
            )
        else:
            self._OCTBscanAnalysisAcquisitionParametersSequence = value
            if "OCTBscanAnalysisAcquisitionParametersSequence" not in self._dataset:
                self._dataset.OCTBscanAnalysisAcquisitionParametersSequence = pydicom.Sequence()
            self._dataset.OCTBscanAnalysisAcquisitionParametersSequence.clear()
            self._dataset.OCTBscanAnalysisAcquisitionParametersSequence.extend([item.to_dataset() for item in value])

    def add_OCTBscanAnalysisAcquisitionParameters(self, item: OCTBscanAnalysisAcquisitionParametersSequenceItem):
        if not isinstance(item, OCTBscanAnalysisAcquisitionParametersSequenceItem):
            raise ValueError(f"Item must be an instance of OCTBscanAnalysisAcquisitionParametersSequenceItem")
        self._OCTBscanAnalysisAcquisitionParametersSequence.append(item)
        if "OCTBscanAnalysisAcquisitionParametersSequence" not in self._dataset:
            self._dataset.OCTBscanAnalysisAcquisitionParametersSequence = pydicom.Sequence()
        self._dataset.OCTBscanAnalysisAcquisitionParametersSequence.append(item.to_dataset())
