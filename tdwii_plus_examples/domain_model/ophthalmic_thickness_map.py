...
class OphthalmicThicknessMap:
    ...
    def AcquisitionMethodCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError("AcquisitionMethodCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def AcquisitionMethodAlgorithmSequence(self, value: Optional[List[AcquisitionMethodAlgorithmSequenceItem]]):
        if value is None:
            ...
            raise ValueError(
                "AcquisitionMethodAlgorithmSequence must be a list of AcquisitionMethodAlgorithmSequenceItem objects"
            )
        else:
    ...
    def add_AcquisitionMethodAlgorithm(self, item: AcquisitionMethodAlgorithmSequenceItem):
        if not isinstance(item, AcquisitionMethodAlgorithmSequenceItem):
            raise ValueError("Item must be an instance of AcquisitionMethodAlgorithmSequenceItem")
    ...
    def OphthalmicThicknessMapTypeCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError("OphthalmicThicknessMapTypeCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def OphthalmicThicknessMappingNormalsSequence(self, value: Optional[List[OphthalmicThicknessMappingNormalsSequenceItem]]):
        if value is None:
            ...
            raise ValueError(
                "OphthalmicThicknessMappingNormalsSequence must be a list of OphthalmicThicknessMappingNormalsSequenceItem"
                " objects"
            )
        else:
    ...
    def add_OphthalmicThicknessMappingNormals(self, item: OphthalmicThicknessMappingNormalsSequenceItem):
        if not isinstance(item, OphthalmicThicknessMappingNormalsSequenceItem):
            raise ValueError("Item must be an instance of OphthalmicThicknessMappingNormalsSequenceItem")
    ...
    def RetinalThicknessDefinitionCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError("RetinalThicknessDefinitionCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def PixelValueMappingToCodedConceptSequence(self, value: Optional[List[PixelValueMappingToCodedConceptSequenceItem]]):
        if value is None:
            ...
            raise ValueError(
                "PixelValueMappingToCodedConceptSequence must be a list of PixelValueMappingToCodedConceptSequenceItem objects"
            )
        else:
    ...
    def add_PixelValueMappingToCodedConcept(self, item: PixelValueMappingToCodedConceptSequenceItem):
        if not isinstance(item, PixelValueMappingToCodedConceptSequenceItem):
            raise ValueError("Item must be an instance of PixelValueMappingToCodedConceptSequenceItem")
    ...
    def RegistrationToLocalizerSequence(self, value: Optional[List[RegistrationToLocalizerSequenceItem]]):
        if value is None:
            ...
            raise ValueError("RegistrationToLocalizerSequence must be a list of RegistrationToLocalizerSequenceItem objects")
        else:
    ...
    def add_RegistrationToLocalizer(self, item: RegistrationToLocalizerSequenceItem):
        if not isinstance(item, RegistrationToLocalizerSequenceItem):
            raise ValueError("Item must be an instance of RegistrationToLocalizerSequenceItem")
    ...
    def RelevantOPTAttributesSequence(self, value: Optional[List[RelevantOPTAttributesSequenceItem]]):
        if value is None:
            ...
            raise ValueError("RelevantOPTAttributesSequence must be a list of RelevantOPTAttributesSequenceItem objects")
        else:
    ...
    def add_RelevantOPTAttributes(self, item: RelevantOPTAttributesSequenceItem):
        if not isinstance(item, RelevantOPTAttributesSequenceItem):
            raise ValueError("Item must be an instance of RelevantOPTAttributesSequenceItem")
    ...
    def OphthalmicThicknessMapQualityRatingSequence(
        ...
        if value is None:
            ...
            raise ValueError(
                "OphthalmicThicknessMapQualityRatingSequence must be a list of OphthalmicThicknessMapQualityRatingSequenceItem"
                " objects"
            )
        else:
