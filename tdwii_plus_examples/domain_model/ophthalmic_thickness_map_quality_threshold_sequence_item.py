...
class OphthalmicThicknessMapQualityThresholdSequenceItem:
    ...
    @property
    def OphthalmicThicknessMapThresholdQualityRating(self) -> Optional[float]:
        if "OphthalmicThicknessMapThresholdQualityRating" in self._dataset:
            return self._dataset.OphthalmicThicknessMapThresholdQualityRating
        return None

    @OphthalmicThicknessMapThresholdQualityRating.setter
    def OphthalmicThicknessMapThresholdQualityRating(self, value: Optional[float]):
        if value is None:
            if "OphthalmicThicknessMapThresholdQualityRating" in self._dataset:
                del self._dataset.OphthalmicThicknessMapThresholdQualityRating
        else:
            self._dataset.OphthalmicThicknessMapThresholdQualityRating = value
