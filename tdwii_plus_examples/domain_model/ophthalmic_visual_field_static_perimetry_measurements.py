...
class OphthalmicVisualFieldStaticPerimetryMeasurements:
    ...
    def TestPointNormalsSequence(self, value: Optional[List[TestPointNormalsSequenceItem]]):
        if value is None:
            ...
            raise ValueError("TestPointNormalsSequence must be a list of TestPointNormalsSequenceItem objects")
        else:
    ...
    def add_TestPointNormals(self, item: TestPointNormalsSequenceItem):
        if not isinstance(item, TestPointNormalsSequenceItem):
            raise ValueError("Item must be an instance of TestPointNormalsSequenceItem")
    ...
    def AgeCorrectedSensitivityDeviationAlgorithmSequence(
        ...
        if value is None:
            ...
            raise ValueError(
                "AgeCorrectedSensitivityDeviationAlgorithmSequence must be a list of"
                " AgeCorrectedSensitivityDeviationAlgorithmSequenceItem objects"
            )
        else:
    ...
    def add_AgeCorrectedSensitivityDeviationAlgorithm(self, item: AgeCorrectedSensitivityDeviationAlgorithmSequenceItem):
        if not isinstance(item, AgeCorrectedSensitivityDeviationAlgorithmSequenceItem):
            raise ValueError("Item must be an instance of AgeCorrectedSensitivityDeviationAlgorithmSequenceItem")
    ...
    def GeneralizedDefectSensitivityDeviationAlgorithmSequence(
        ...
        if value is None:
            ...
            raise ValueError(
                "GeneralizedDefectSensitivityDeviationAlgorithmSequence must be a list of"
                " GeneralizedDefectSensitivityDeviationAlgorithmSequenceItem objects"
            )
        else:
    ...
    def VisualFieldTestPointSequence(self, value: Optional[List[VisualFieldTestPointSequenceItem]]):
        if value is None:
            ...
            raise ValueError("VisualFieldTestPointSequence must be a list of VisualFieldTestPointSequenceItem objects")
        else:
    ...
    def add_VisualFieldTestPoint(self, item: VisualFieldTestPointSequenceItem):
        if not isinstance(item, VisualFieldTestPointSequenceItem):
            raise ValueError("Item must be an instance of VisualFieldTestPointSequenceItem")
    ...
    def ScreeningBaselineMeasuredSequence(self, value: Optional[List[ScreeningBaselineMeasuredSequenceItem]]):
        if value is None:
            ...
            raise ValueError(
                "ScreeningBaselineMeasuredSequence must be a list of ScreeningBaselineMeasuredSequenceItem objects"
            )
        else:
    ...
    def add_ScreeningBaselineMeasured(self, item: ScreeningBaselineMeasuredSequenceItem):
        if not isinstance(item, ScreeningBaselineMeasuredSequenceItem):
            raise ValueError("Item must be an instance of ScreeningBaselineMeasuredSequenceItem")
    ...
    def ResultsNormalsSequence(self, value: Optional[List[ResultsNormalsSequenceItem]]):
        if value is None:
            ...
            raise ValueError("ResultsNormalsSequence must be a list of ResultsNormalsSequenceItem objects")
        else:
    ...
    def add_ResultsNormals(self, item: ResultsNormalsSequenceItem):
        if not isinstance(item, ResultsNormalsSequenceItem):
            raise ValueError("Item must be an instance of ResultsNormalsSequenceItem")
    ...
    def VisualFieldGlobalResultsIndexSequence(self, value: Optional[List[VisualFieldGlobalResultsIndexSequenceItem]]):
        if value is None:
            ...
            raise ValueError(
                "VisualFieldGlobalResultsIndexSequence must be a list of VisualFieldGlobalResultsIndexSequenceItem objects"
            )
        else:
    ...
    def add_VisualFieldGlobalResultsIndex(self, item: VisualFieldGlobalResultsIndexSequenceItem):
        if not isinstance(item, VisualFieldGlobalResultsIndexSequenceItem):
            raise ValueError("Item must be an instance of VisualFieldGlobalResultsIndexSequenceItem")
    ...
    def OphthalmicPatientClinicalInformationLeftEyeSequence(
        ...
        if value is None:
            ...
            raise ValueError(
                "OphthalmicPatientClinicalInformationLeftEyeSequence must be a list of"
                " OphthalmicPatientClinicalInformationLeftEyeSequenceItem objects"
            )
        else:
    ...
    def OphthalmicPatientClinicalInformationRightEyeSequence(
        ...
        if value is None:
            ...
            raise ValueError(
                "OphthalmicPatientClinicalInformationRightEyeSequence must be a list of"
                " OphthalmicPatientClinicalInformationRightEyeSequenceItem objects"
            )
        else:
    ...
    def add_OphthalmicPatientClinicalInformationRightEye(self, item: OphthalmicPatientClinicalInformationRightEyeSequenceItem):
        if not isinstance(item, OphthalmicPatientClinicalInformationRightEyeSequenceItem):
            raise ValueError("Item must be an instance of OphthalmicPatientClinicalInformationRightEyeSequenceItem")
    ...
    def ScreeningTestModeCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError("ScreeningTestModeCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def StimulusColorCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError("StimulusColorCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def BackgroundIlluminationColorCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError("BackgroundIlluminationColorCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def FixationSequence(self, value: Optional[List[FixationSequenceItem]]):
        if value is None:
            ...
            raise ValueError("FixationSequence must be a list of FixationSequenceItem objects")
        else:
    ...
    def add_Fixation(self, item: FixationSequenceItem):
        if not isinstance(item, FixationSequenceItem):
            raise ValueError("Item must be an instance of FixationSequenceItem")
    ...
    def VisualFieldCatchTrialSequence(self, value: Optional[List[VisualFieldCatchTrialSequenceItem]]):
        if value is None:
            ...
            raise ValueError("VisualFieldCatchTrialSequence must be a list of VisualFieldCatchTrialSequenceItem objects")
        else:
    ...
    def add_VisualFieldCatchTrial(self, item: VisualFieldCatchTrialSequenceItem):
        if not isinstance(item, VisualFieldCatchTrialSequenceItem):
            raise ValueError("Item must be an instance of VisualFieldCatchTrialSequenceItem")
    ...
    def VisualFieldTestReliabilityGlobalIndexSequence(
        ...
        if value is None:
            ...
            raise ValueError(
                "VisualFieldTestReliabilityGlobalIndexSequence must be a list of"
                " VisualFieldTestReliabilityGlobalIndexSequenceItem objects"
            )
        else:
    ...
    def add_VisualFieldTestReliabilityGlobalIndex(self, item: VisualFieldTestReliabilityGlobalIndexSequenceItem):
        if not isinstance(item, VisualFieldTestReliabilityGlobalIndexSequenceItem):
            raise ValueError("Item must be an instance of VisualFieldTestReliabilityGlobalIndexSequenceItem")
