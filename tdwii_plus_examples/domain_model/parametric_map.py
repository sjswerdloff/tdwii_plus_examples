...
class ParametricMap:
    ...
    @property
    def FloatPixelPaddingValue(self) -> Optional[float]:
        if "FloatPixelPaddingValue" in self._dataset:
            return self._dataset.FloatPixelPaddingValue
        return None

    @FloatPixelPaddingValue.setter
    def FloatPixelPaddingValue(self, value: Optional[float]):
        if value is None:
            if "FloatPixelPaddingValue" in self._dataset:
                del self._dataset.FloatPixelPaddingValue
        else:
            self._dataset.FloatPixelPaddingValue = value

    @property
    def FloatPixelPaddingRangeLimit(self) -> Optional[float]:
        if "FloatPixelPaddingRangeLimit" in self._dataset:
            return self._dataset.FloatPixelPaddingRangeLimit
        return None

    @FloatPixelPaddingRangeLimit.setter
    def FloatPixelPaddingRangeLimit(self, value: Optional[float]):
        if value is None:
            if "FloatPixelPaddingRangeLimit" in self._dataset:
                del self._dataset.FloatPixelPaddingRangeLimit
        else:
            self._dataset.FloatPixelPaddingRangeLimit = value

    @property
    def FloatPixelData(self) -> Optional[bytes]:
        if "FloatPixelData" in self._dataset:
            return self._dataset.FloatPixelData
        return None

    @FloatPixelData.setter
    def FloatPixelData(self, value: Optional[bytes]):
        if value is None:
            if "FloatPixelData" in self._dataset:
                del self._dataset.FloatPixelData
        else:
            self._dataset.FloatPixelData = value
    ...
    @property
    def DoubleFloatPixelPaddingValue(self) -> Optional[float]:
        if "DoubleFloatPixelPaddingValue" in self._dataset:
            return self._dataset.DoubleFloatPixelPaddingValue
        return None

    @DoubleFloatPixelPaddingValue.setter
    def DoubleFloatPixelPaddingValue(self, value: Optional[float]):
        if value is None:
            if "DoubleFloatPixelPaddingValue" in self._dataset:
                del self._dataset.DoubleFloatPixelPaddingValue
        else:
            self._dataset.DoubleFloatPixelPaddingValue = value

    @property
    def DoubleFloatPixelPaddingRangeLimit(self) -> Optional[float]:
        if "DoubleFloatPixelPaddingRangeLimit" in self._dataset:
            return self._dataset.DoubleFloatPixelPaddingRangeLimit
        return None

    @DoubleFloatPixelPaddingRangeLimit.setter
    def DoubleFloatPixelPaddingRangeLimit(self, value: Optional[float]):
        if value is None:
            if "DoubleFloatPixelPaddingRangeLimit" in self._dataset:
                del self._dataset.DoubleFloatPixelPaddingRangeLimit
        else:
            self._dataset.DoubleFloatPixelPaddingRangeLimit = value

    @property
    def DoubleFloatPixelData(self) -> Optional[bytes]:
        if "DoubleFloatPixelData" in self._dataset:
            return self._dataset.DoubleFloatPixelData
        return None

    @DoubleFloatPixelData.setter
    def DoubleFloatPixelData(self, value: Optional[bytes]):
        if value is None:
            if "DoubleFloatPixelData" in self._dataset:
                del self._dataset.DoubleFloatPixelData
        else:
            self._dataset.DoubleFloatPixelData = value
