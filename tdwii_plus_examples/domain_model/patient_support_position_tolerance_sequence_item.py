...
class PatientSupportPositionToleranceSequenceItem:
    ...
    @property
    def PatientSupportPositionToleranceOrderIndex(self) -> Optional[int]:
        if "PatientSupportPositionToleranceOrderIndex" in self._dataset:
            return self._dataset.PatientSupportPositionToleranceOrderIndex
        return None

    @PatientSupportPositionToleranceOrderIndex.setter
    def PatientSupportPositionToleranceOrderIndex(self, value: Optional[int]):
        if value is None:
            if "PatientSupportPositionToleranceOrderIndex" in self._dataset:
                del self._dataset.PatientSupportPositionToleranceOrderIndex
        else:
            self._dataset.PatientSupportPositionToleranceOrderIndex = value
