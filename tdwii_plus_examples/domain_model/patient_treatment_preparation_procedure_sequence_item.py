...
class PatientTreatmentPreparationProcedureSequenceItem:
    ...
    def PatientTreatmentPreparationDeviceSequence(self, value: Optional[List[PatientTreatmentPreparationDeviceSequenceItem]]):
        if value is None:
            ...
            raise ValueError(
                f"PatientTreatmentPreparationDeviceSequence must be a list of PatientTreatmentPreparationDeviceSequenceItem objects"
            )
        else:
    ...
    def add_PatientTreatmentPreparationDevice(self, item: PatientTreatmentPreparationDeviceSequenceItem):
        if not isinstance(item, PatientTreatmentPreparationDeviceSequenceItem):
            raise ValueError(f"Item must be an instance of PatientTreatmentPreparationDeviceSequenceItem")
    ...
    def PatientTreatmentPreparationProcedureCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"PatientTreatmentPreparationProcedureCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def PatientTreatmentPreparationProcedureParameterSequence(
        ...
        if value is None:
            ...
            raise ValueError(
                f"PatientTreatmentPreparationProcedureParameterSequence must be a list of PatientTreatmentPreparationProcedureParameterSequenceItem objects"
            )
        else:
    ...
    def add_PatientTreatmentPreparationProcedureParameter(
        ...
        if not isinstance(item, PatientTreatmentPreparationProcedureParameterSequenceItem):
            raise ValueError(f"Item must be an instance of PatientTreatmentPreparationProcedureParameterSequenceItem")
