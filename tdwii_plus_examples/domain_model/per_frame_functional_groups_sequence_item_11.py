...
class PerFrameFunctionalGroupsSequenceItem:
    ...
    def ConfocalMicroscopyImageFrameTypeSequence(self, value: Optional[List[ConfocalMicroscopyImageFrameTypeSequenceItem]]):
        if value is None:
            ...
            raise ValueError(
                f"ConfocalMicroscopyImageFrameTypeSequence must be a list of ConfocalMicroscopyImageFrameTypeSequenceItem objects"
            )
        else:
    ...
    def add_ConfocalMicroscopyImageFrameType(self, item: ConfocalMicroscopyImageFrameTypeSequenceItem):
        if not isinstance(item, ConfocalMicroscopyImageFrameTypeSequenceItem):
            raise ValueError(f"Item must be an instance of ConfocalMicroscopyImageFrameTypeSequenceItem")
