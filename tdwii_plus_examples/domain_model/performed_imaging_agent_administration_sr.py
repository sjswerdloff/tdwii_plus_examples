...
class PerformedImagingAgentAdministrationSr:
    ...
    def VerifyingObserverSequence(self, value: Optional[List[VerifyingObserverSequenceItem]]):
        if value is None:
            ...
            raise ValueError("VerifyingObserverSequence must be a list of VerifyingObserverSequenceItem objects")
        else:
    ...
    def add_VerifyingObserver(self, item: VerifyingObserverSequenceItem):
        if not isinstance(item, VerifyingObserverSequenceItem):
            raise ValueError("Item must be an instance of VerifyingObserverSequenceItem")
    ...
    def AuthorObserverSequence(self, value: Optional[List[AuthorObserverSequenceItem]]):
        if value is None:
            ...
            raise ValueError("AuthorObserverSequence must be a list of AuthorObserverSequenceItem objects")
        else:
    ...
    def add_AuthorObserver(self, item: AuthorObserverSequenceItem):
        if not isinstance(item, AuthorObserverSequenceItem):
            raise ValueError("Item must be an instance of AuthorObserverSequenceItem")
    ...
    def ParticipantSequence(self, value: Optional[List[ParticipantSequenceItem]]):
        if value is None:
            ...
            raise ValueError("ParticipantSequence must be a list of ParticipantSequenceItem objects")
        else:
    ...
    def add_Participant(self, item: ParticipantSequenceItem):
        if not isinstance(item, ParticipantSequenceItem):
            raise ValueError("Item must be an instance of ParticipantSequenceItem")
    ...
    def PredecessorDocumentsSequence(self, value: Optional[List[PredecessorDocumentsSequenceItem]]):
        if value is None:
            ...
            raise ValueError("PredecessorDocumentsSequence must be a list of PredecessorDocumentsSequenceItem objects")
        else:
    ...
    def add_PredecessorDocuments(self, item: PredecessorDocumentsSequenceItem):
        if not isinstance(item, PredecessorDocumentsSequenceItem):
            raise ValueError("Item must be an instance of PredecessorDocumentsSequenceItem")
    ...
    def PerformedProcedureCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError("PerformedProcedureCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def PertinentOtherEvidenceSequence(self, value: Optional[List[PertinentOtherEvidenceSequenceItem]]):
        if value is None:
            ...
            raise ValueError("PertinentOtherEvidenceSequence must be a list of PertinentOtherEvidenceSequenceItem objects")
        else:
