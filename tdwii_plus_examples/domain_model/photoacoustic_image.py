...
class PhotoacousticImage:
    ...
    def TransducerResponseSequence(self, value: Optional[List[TransducerResponseSequenceItem]]):
        if value is None:
            ...
            raise ValueError("TransducerResponseSequence must be a list of TransducerResponseSequenceItem objects")
        else:
    ...
    def add_TransducerResponse(self, item: TransducerResponseSequenceItem):
        if not isinstance(item, TransducerResponseSequenceItem):
            raise ValueError("Item must be an instance of TransducerResponseSequenceItem")
    ...
    def TransducerTechnologySequence(self, value: Optional[List[TransducerTechnologySequenceItem]]):
        if value is None:
            ...
            raise ValueError("TransducerTechnologySequence must be a list of TransducerTechnologySequenceItem objects")
        else:
    ...
    def add_TransducerTechnology(self, item: TransducerTechnologySequenceItem):
        if not isinstance(item, TransducerTechnologySequenceItem):
            raise ValueError("Item must be an instance of TransducerTechnologySequenceItem")
    ...
    def ExcitationWavelengthSequence(self, value: Optional[List[ExcitationWavelengthSequenceItem]]):
        if value is None:
            ...
            raise ValueError("ExcitationWavelengthSequence must be a list of ExcitationWavelengthSequenceItem objects")
        else:
    ...
    def add_ExcitationWavelength(self, item: ExcitationWavelengthSequenceItem):
        if not isinstance(item, ExcitationWavelengthSequenceItem):
            raise ValueError("Item must be an instance of ExcitationWavelengthSequenceItem")
    ...
    def AcousticCouplingMediumCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError("AcousticCouplingMediumCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def SoundSpeedCorrectionMechanismCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError("SoundSpeedCorrectionMechanismCodeSequence must be a list of CodeSequenceItem objects")
        else:
