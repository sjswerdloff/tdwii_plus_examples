...
class RadiationGenerationModeSequenceItem:
    ...
    def RadiationGenerationModeMachineCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"RadiationGenerationModeMachineCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def RadiationTypeCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"RadiationTypeCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def RadiationFluenceModifierCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"RadiationFluenceModifierCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def EnergyUnitCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"EnergyUnitCodeSequence must be a list of CodeSequenceItem objects")
        else:
