...
class RawData:
    ...
    @property
    def CreatorVersionUID(self) -> Optional[str]:
        if "CreatorVersionUID" in self._dataset:
            return self._dataset.CreatorVersionUID
        return None

    @CreatorVersionUID.setter
    def CreatorVersionUID(self, value: Optional[str]):
        if value is None:
            if "CreatorVersionUID" in self._dataset:
                del self._dataset.CreatorVersionUID
        else:
            self._dataset.CreatorVersionUID = value
