...
class ReferencedBolusSequenceItem:
    ...
    @property
    def BolusDescription(self) -> Optional[str]:
        if "BolusDescription" in self._dataset:
            return self._dataset.BolusDescription
        return None

    @BolusDescription.setter
    def BolusDescription(self, value: Optional[str]):
        if value is None:
            if "BolusDescription" in self._dataset:
                del self._dataset.BolusDescription
        else:
            self._dataset.BolusDescription = value
