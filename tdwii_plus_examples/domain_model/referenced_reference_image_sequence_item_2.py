...
class ReferencedReferenceImageSequenceItem:
    ...
    @property
    def ReferenceImageNumber(self) -> Optional[int]:
        if "ReferenceImageNumber" in self._dataset:
            return self._dataset.ReferenceImageNumber
        return None

    @ReferenceImageNumber.setter
    def ReferenceImageNumber(self, value: Optional[int]):
        if value is None:
            if "ReferenceImageNumber" in self._dataset:
                del self._dataset.ReferenceImageNumber
        else:
            self._dataset.ReferenceImageNumber = value
