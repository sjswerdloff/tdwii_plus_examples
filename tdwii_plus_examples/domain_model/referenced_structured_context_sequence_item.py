...
class ReferencedStructuredContextSequenceItem:
    ...
    @property
    def ReferencedContentItem(self) -> Optional[str]:
        if "ReferencedContentItem" in self._dataset:
            return self._dataset.ReferencedContentItem
        return None

    @ReferencedContentItem.setter
    def ReferencedContentItem(self, value: Optional[str]):
        if value is None:
            if "ReferencedContentItem" in self._dataset:
                del self._dataset.ReferencedContentItem
        else:
            self._dataset.ReferencedContentItem = value
