...
class RTAnatomicPrescriptionSequenceItem:
    ...
    def ConceptualVolumeCategoryCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"ConceptualVolumeCategoryCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def ConceptualVolumeTypeCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"ConceptualVolumeTypeCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def ConceptualVolumeTypeModifierCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"ConceptualVolumeTypeModifierCodeSequence must be a list of CodeSequenceItem objects")
        else:
