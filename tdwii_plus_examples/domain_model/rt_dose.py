...
class RtDose:
    ...
    def PlanOverviewSequence(self, value: Optional[List[PlanOverviewSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"PlanOverviewSequence must be a list of PlanOverviewSequenceItem objects")
        else:
    ...
    def add_PlanOverview(self, item: PlanOverviewSequenceItem):
        if not isinstance(item, PlanOverviewSequenceItem):
            raise ValueError(f"Item must be an instance of PlanOverviewSequenceItem")
    ...
    def DVHSequence(self, value: Optional[List[DVHSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"DVHSequence must be a list of DVHSequenceItem objects")
        else:
    ...
    def add_DVH(self, item: DVHSequenceItem):
        if not isinstance(item, DVHSequenceItem):
            raise ValueError(f"Item must be an instance of DVHSequenceItem")
