...
class RtImage:
    ...
    def ExposureSequence(self, value: Optional[List[ExposureSequenceItem]]):
        if value is None:
            ...
            raise ValueError("ExposureSequence must be a list of ExposureSequenceItem objects")
        else:
    ...
    def add_Exposure(self, item: ExposureSequenceItem):
        if not isinstance(item, ExposureSequenceItem):
            raise ValueError("Item must be an instance of ExposureSequenceItem")
    ...
    def FluenceMapSequence(self, value: Optional[List[FluenceMapSequenceItem]]):
        if value is None:
            ...
            raise ValueError("FluenceMapSequence must be a list of FluenceMapSequenceItem objects")
        else:
    ...
    def add_FluenceMap(self, item: FluenceMapSequenceItem):
        if not isinstance(item, FluenceMapSequenceItem):
            raise ValueError("Item must be an instance of FluenceMapSequenceItem")
