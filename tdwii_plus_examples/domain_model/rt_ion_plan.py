...
class RtIonPlan:
    ...
    def IonBeamSequence(self, value: Optional[List[IonBeamSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"IonBeamSequence must be a list of IonBeamSequenceItem objects")
        else:
    ...
    def add_IonBeam(self, item: IonBeamSequenceItem):
        if not isinstance(item, IonBeamSequenceItem):
            raise ValueError(f"Item must be an instance of IonBeamSequenceItem")
    ...
    def IonToleranceTableSequence(self, value: Optional[List[IonToleranceTableSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"IonToleranceTableSequence must be a list of IonToleranceTableSequenceItem objects")
        else:
    ...
    def add_IonToleranceTable(self, item: IonToleranceTableSequenceItem):
        if not isinstance(item, IonToleranceTableSequenceItem):
            raise ValueError(f"Item must be an instance of IonToleranceTableSequenceItem")
