...
class RtRadiationRecordSet:
    ...
    @property
    def RTTreatmentFractionCompletionStatus(self) -> Optional[str]:
        if "RTTreatmentFractionCompletionStatus" in self._dataset:
            return self._dataset.RTTreatmentFractionCompletionStatus
        return None

    @RTTreatmentFractionCompletionStatus.setter
    def RTTreatmentFractionCompletionStatus(self, value: Optional[str]):
        if value is None:
            if "RTTreatmentFractionCompletionStatus" in self._dataset:
                del self._dataset.RTTreatmentFractionCompletionStatus
        else:
            self._dataset.RTTreatmentFractionCompletionStatus = value

    @property
    def RTRadiationSetUsage(self) -> Optional[str]:
        if "RTRadiationSetUsage" in self._dataset:
            return self._dataset.RTRadiationSetUsage
        return None

    @RTRadiationSetUsage.setter
    def RTRadiationSetUsage(self, value: Optional[str]):
        if value is None:
            if "RTRadiationSetUsage" in self._dataset:
                del self._dataset.RTRadiationSetUsage
        else:
            self._dataset.RTRadiationSetUsage = value
