...
class RtTreatmentPreparation:
    ...
    def RTPatientPositionScopeSequence(self, value: Optional[List[RTPatientPositionScopeSequenceItem]]):
        if value is None:
            ...
            raise ValueError("RTPatientPositionScopeSequence must be a list of RTPatientPositionScopeSequenceItem objects")
        else:
    ...
    def add_RTPatientPositionScope(self, item: RTPatientPositionScopeSequenceItem):
        if not isinstance(item, RTPatientPositionScopeSequenceItem):
            raise ValueError("Item must be an instance of RTPatientPositionScopeSequenceItem")
    ...
    def RTTreatmentPreparationPatientPositionSequence(
        ...
        if value is None:
            ...
            raise ValueError(
                "RTTreatmentPreparationPatientPositionSequence must be a list of"
                " RTTreatmentPreparationPatientPositionSequenceItem objects"
            )
        else:
    ...
    def add_RTTreatmentPreparationPatientPosition(self, item: RTTreatmentPreparationPatientPositionSequenceItem):
        if not isinstance(item, RTTreatmentPreparationPatientPositionSequenceItem):
            raise ValueError("Item must be an instance of RTTreatmentPreparationPatientPositionSequenceItem")
    ...
    def ReferencedPatientSetupPhotoSequence(self, value: Optional[List[ReferencedPatientSetupPhotoSequenceItem]]):
        if value is None:
            ...
            raise ValueError(
                "ReferencedPatientSetupPhotoSequence must be a list of ReferencedPatientSetupPhotoSequenceItem objects"
            )
        else:
    ...
    def add_ReferencedPatientSetupPhoto(self, item: ReferencedPatientSetupPhotoSequenceItem):
        if not isinstance(item, ReferencedPatientSetupPhotoSequenceItem):
            raise ValueError("Item must be an instance of ReferencedPatientSetupPhotoSequenceItem")
    ...
    def PatientTreatmentPreparationMethodCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError("PatientTreatmentPreparationMethodCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def PatientTreatmentPreparationProcedureSequence(
        ...
        if value is None:
            ...
            raise ValueError(
                "PatientTreatmentPreparationProcedureSequence must be a list of"
                " PatientTreatmentPreparationProcedureSequenceItem objects"
            )
        else:
    ...
    def add_PatientTreatmentPreparationProcedure(self, item: PatientTreatmentPreparationProcedureSequenceItem):
        if not isinstance(item, PatientTreatmentPreparationProcedureSequenceItem):
            raise ValueError("Item must be an instance of PatientTreatmentPreparationProcedureSequenceItem")
