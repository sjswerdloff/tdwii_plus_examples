...
class Segmentation:
    ...
    def TotalPixelMatrixOriginSequence(self, value: Optional[List[TotalPixelMatrixOriginSequenceItem]]):
        if value is None:
            ...
            raise ValueError("TotalPixelMatrixOriginSequence must be a list of TotalPixelMatrixOriginSequenceItem objects")
        else:
    ...
    def add_TotalPixelMatrixOrigin(self, item: TotalPixelMatrixOriginSequenceItem):
        if not isinstance(item, TotalPixelMatrixOriginSequenceItem):
            raise ValueError("Item must be an instance of TotalPixelMatrixOriginSequenceItem")
    ...
    def SegmentSequence(self, value: Optional[List[SegmentSequenceItem]]):
        if value is None:
            ...
            raise ValueError("SegmentSequence must be a list of SegmentSequenceItem objects")
        else:
    ...
    def add_Segment(self, item: SegmentSequenceItem):
        if not isinstance(item, SegmentSequenceItem):
            raise ValueError("Item must be an instance of SegmentSequenceItem")
