...
class SharedFunctionalGroupsSequenceItem:
    ...
    def StoredValueColorRangeSequence(self, value: Optional[List[StoredValueColorRangeSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"StoredValueColorRangeSequence must be a list of StoredValueColorRangeSequenceItem objects")
        else:
    ...
    def add_StoredValueColorRange(self, item: StoredValueColorRangeSequenceItem):
        if not isinstance(item, StoredValueColorRangeSequenceItem):
            raise ValueError(f"Item must be an instance of StoredValueColorRangeSequenceItem")
    ...
    def ParametricMapFrameTypeSequence(self, value: Optional[List[ParametricMapFrameTypeSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"ParametricMapFrameTypeSequence must be a list of ParametricMapFrameTypeSequenceItem objects")
        else:
    ...
    def add_ParametricMapFrameType(self, item: ParametricMapFrameTypeSequenceItem):
        if not isinstance(item, ParametricMapFrameTypeSequenceItem):
            raise ValueError(f"Item must be an instance of ParametricMapFrameTypeSequenceItem")
