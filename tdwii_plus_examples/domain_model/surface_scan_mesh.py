...
class SurfaceScanMesh:
    ...
    def ReferencedSurfaceDataSequence(self, value: Optional[List[ReferencedSurfaceDataSequenceItem]]):
        if value is None:
            ...
            raise ValueError("ReferencedSurfaceDataSequence must be a list of ReferencedSurfaceDataSequenceItem objects")
        else:
    ...
    def add_ReferencedSurfaceData(self, item: ReferencedSurfaceDataSequenceItem):
        if not isinstance(item, ReferencedSurfaceDataSequenceItem):
            raise ValueError("Item must be an instance of ReferencedSurfaceDataSequenceItem")
    ...
    def SurfaceSequence(self, value: Optional[List[SurfaceSequenceItem]]):
        if value is None:
            ...
            raise ValueError("SurfaceSequence must be a list of SurfaceSequenceItem objects")
        else:
    ...
    def add_Surface(self, item: SurfaceSequenceItem):
        if not isinstance(item, SurfaceSequenceItem):
            raise ValueError("Item must be an instance of SurfaceSequenceItem")
    ...
    def UVMappingSequence(self, value: Optional[List[UVMappingSequenceItem]]):
        if value is None:
            ...
            raise ValueError("UVMappingSequence must be a list of UVMappingSequenceItem objects")
        else:
    ...
    def add_UVMapping(self, item: UVMappingSequenceItem):
        if not isinstance(item, UVMappingSequenceItem):
            raise ValueError("Item must be an instance of UVMappingSequenceItem")
    ...
    def SurfaceScanAcquisitionTypeCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError("SurfaceScanAcquisitionTypeCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def SurfaceScanModeCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError("SurfaceScanModeCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def RegistrationMethodCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError("RegistrationMethodCodeSequence must be a list of CodeSequenceItem objects")
        else:
