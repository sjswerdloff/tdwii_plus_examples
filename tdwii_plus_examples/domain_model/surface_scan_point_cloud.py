...
class SurfaceScanPointCloud:
    ...
    @property
    def SurfacePointPresentationValueData(self) -> Optional[List[int]]:
        if "SurfacePointPresentationValueData" in self._dataset:
            return self._dataset.SurfacePointPresentationValueData
        return None

    @SurfacePointPresentationValueData.setter
    def SurfacePointPresentationValueData(self, value: Optional[List[int]]):
        if value is None:
            if "SurfacePointPresentationValueData" in self._dataset:
                del self._dataset.SurfacePointPresentationValueData
        else:
            self._dataset.SurfacePointPresentationValueData = value

    @property
    def SurfacePointColorCIELabValueData(self) -> Optional[List[int]]:
        if "SurfacePointColorCIELabValueData" in self._dataset:
            return self._dataset.SurfacePointColorCIELabValueData
        return None

    @SurfacePointColorCIELabValueData.setter
    def SurfacePointColorCIELabValueData(self, value: Optional[List[int]]):
        if value is None:
            if "SurfacePointColorCIELabValueData" in self._dataset:
                del self._dataset.SurfacePointColorCIELabValueData
        else:
            self._dataset.SurfacePointColorCIELabValueData = value
