...
class ToleranceTableSequenceItem:
    ...
    @property
    def TableTopEccentricAngleTolerance(self) -> Optional[Decimal]:
        if "TableTopEccentricAngleTolerance" in self._dataset:
            return self._dataset.TableTopEccentricAngleTolerance
        return None

    @TableTopEccentricAngleTolerance.setter
    def TableTopEccentricAngleTolerance(self, value: Optional[Decimal]):
        if value is None:
            if "TableTopEccentricAngleTolerance" in self._dataset:
                del self._dataset.TableTopEccentricAngleTolerance
        else:
            self._dataset.TableTopEccentricAngleTolerance = value
    ...
    def GantryPitchAngleTolerance(self) -> Optional[float]:
        if "GantryPitchAngleTolerance" in self._dataset:
            return self._dataset.GantryPitchAngleTolerance
        return None

    @GantryPitchAngleTolerance.setter
    def GantryPitchAngleTolerance(self, value: Optional[float]):
        if value is None:
            if "GantryPitchAngleTolerance" in self._dataset:
                del self._dataset.GantryPitchAngleTolerance
        else:
            self._dataset.GantryPitchAngleTolerance = value
