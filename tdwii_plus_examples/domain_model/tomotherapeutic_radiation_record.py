...
from .tomotherapeutic_control_point_sequence_item import (
    TomotherapeuticControlPointSequenceItem,
)
...
class TomotherapeuticRadiationRecord:
    def __init__(self, dataset: Optional[pydicom.Dataset] = None):
        ...
        self._TomotherapeuticControlPointSequence: List[TomotherapeuticControlPointSequenceItem] = []
    ...
    @property
    def TomotherapeuticControlPointSequence(self) -> Optional[List[TomotherapeuticControlPointSequenceItem]]:
        if "TomotherapeuticControlPointSequence" in self._dataset:
            if len(self._TomotherapeuticControlPointSequence) == len(self._dataset.TomotherapeuticControlPointSequence):
                return self._TomotherapeuticControlPointSequence
            else:
                return [TomotherapeuticControlPointSequenceItem(x) for x in self._dataset.TomotherapeuticControlPointSequence]
        return None

    @TomotherapeuticControlPointSequence.setter
    def TomotherapeuticControlPointSequence(self, value: Optional[List[TomotherapeuticControlPointSequenceItem]]):
        if value is None:
            self._TomotherapeuticControlPointSequence = []
            if "TomotherapeuticControlPointSequence" in self._dataset:
                del self._dataset.TomotherapeuticControlPointSequence
        elif not isinstance(value, list) or not all(
            isinstance(item, TomotherapeuticControlPointSequenceItem) for item in value
        ):
            raise ValueError(
                f"TomotherapeuticControlPointSequence must be a list of TomotherapeuticControlPointSequenceItem objects"
            )
        else:
            self._TomotherapeuticControlPointSequence = value
            if "TomotherapeuticControlPointSequence" not in self._dataset:
                self._dataset.TomotherapeuticControlPointSequence = pydicom.Sequence()
            self._dataset.TomotherapeuticControlPointSequence.clear()
            self._dataset.TomotherapeuticControlPointSequence.extend([item.to_dataset() for item in value])

    def add_TomotherapeuticControlPoint(self, item: TomotherapeuticControlPointSequenceItem):
        if not isinstance(item, TomotherapeuticControlPointSequenceItem):
            raise ValueError(f"Item must be an instance of TomotherapeuticControlPointSequenceItem")
        self._TomotherapeuticControlPointSequence.append(item)
        if "TomotherapeuticControlPointSequence" not in self._dataset:
            self._dataset.TomotherapeuticControlPointSequence = pydicom.Sequence()
        self._dataset.TomotherapeuticControlPointSequence.append(item.to_dataset())
