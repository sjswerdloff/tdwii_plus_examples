...
class WedgeDefinitionSequenceItem:
    ...
    @property
    def RadiationBeamWedgeAngle(self) -> Optional[float]:
        if "RadiationBeamWedgeAngle" in self._dataset:
            return self._dataset.RadiationBeamWedgeAngle
        return None

    @RadiationBeamWedgeAngle.setter
    def RadiationBeamWedgeAngle(self, value: Optional[float]):
        if value is None:
            if "RadiationBeamWedgeAngle" in self._dataset:
                del self._dataset.RadiationBeamWedgeAngle
        else:
            self._dataset.RadiationBeamWedgeAngle = value

    @property
    def RadiationBeamEffectiveWedgeAngle(self) -> Optional[float]:
        if "RadiationBeamEffectiveWedgeAngle" in self._dataset:
            return self._dataset.RadiationBeamEffectiveWedgeAngle
        return None

    @RadiationBeamEffectiveWedgeAngle.setter
    def RadiationBeamEffectiveWedgeAngle(self, value: Optional[float]):
        if value is None:
            if "RadiationBeamEffectiveWedgeAngle" in self._dataset:
                del self._dataset.RadiationBeamEffectiveWedgeAngle
        else:
            self._dataset.RadiationBeamEffectiveWedgeAngle = value
