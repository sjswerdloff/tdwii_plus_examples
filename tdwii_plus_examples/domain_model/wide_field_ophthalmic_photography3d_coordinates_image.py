...
class WideFieldOphthalmicPhotography3dCoordinatesImage:
    ...
    def WideFieldOphthalmicPhotographyQualityRatingSequence(
        ...
        if value is None:
            ...
            raise ValueError(
                "WideFieldOphthalmicPhotographyQualityRatingSequence must be a list of"
                " WideFieldOphthalmicPhotographyQualityRatingSequenceItem objects"
            )
        else:
    ...
    def add_WideFieldOphthalmicPhotographyQualityRating(self, item: WideFieldOphthalmicPhotographyQualityRatingSequenceItem):
        if not isinstance(item, WideFieldOphthalmicPhotographyQualityRatingSequenceItem):
            raise ValueError("Item must be an instance of WideFieldOphthalmicPhotographyQualityRatingSequenceItem")
    ...
    def TransformationMethodCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError("TransformationMethodCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def TransformationAlgorithmSequence(self, value: Optional[List[TransformationAlgorithmSequenceItem]]):
        if value is None:
            ...
            raise ValueError("TransformationAlgorithmSequence must be a list of TransformationAlgorithmSequenceItem objects")
        else:
    ...
    def add_TransformationAlgorithm(self, item: TransformationAlgorithmSequenceItem):
        if not isinstance(item, TransformationAlgorithmSequenceItem):
            raise ValueError("Item must be an instance of TransformationAlgorithmSequenceItem")
    ...
    def TwoDimensionalToThreeDimensionalMapSequence(
        ...
        if value is None:
            ...
            raise ValueError(
                "TwoDimensionalToThreeDimensionalMapSequence must be a list of TwoDimensionalToThreeDimensionalMapSequenceItem"
                " objects"
            )
        else:
