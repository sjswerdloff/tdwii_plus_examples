...
class WideFieldOphthalmicPhotographyStereographicProjectionImage:
    ...
    @property
    def XCoordinatesCenterPixelViewAngle(self) -> Optional[float]:
        if "XCoordinatesCenterPixelViewAngle" in self._dataset:
            return self._dataset.XCoordinatesCenterPixelViewAngle
        return None

    @XCoordinatesCenterPixelViewAngle.setter
    def XCoordinatesCenterPixelViewAngle(self, value: Optional[float]):
        if value is None:
            if "XCoordinatesCenterPixelViewAngle" in self._dataset:
                del self._dataset.XCoordinatesCenterPixelViewAngle
        else:
            self._dataset.XCoordinatesCenterPixelViewAngle = value

    @property
    def YCoordinatesCenterPixelViewAngle(self) -> Optional[float]:
        if "YCoordinatesCenterPixelViewAngle" in self._dataset:
            return self._dataset.YCoordinatesCenterPixelViewAngle
        return None

    @YCoordinatesCenterPixelViewAngle.setter
    def YCoordinatesCenterPixelViewAngle(self, value: Optional[float]):
        if value is None:
            if "YCoordinatesCenterPixelViewAngle" in self._dataset:
                del self._dataset.YCoordinatesCenterPixelViewAngle
        else:
            self._dataset.YCoordinatesCenterPixelViewAngle = value
