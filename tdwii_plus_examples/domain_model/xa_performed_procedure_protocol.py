...
class XaPerformedProcedureProtocol:
    ...
    def PotentialScheduledProtocolCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"PotentialScheduledProtocolCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def PotentialRequestedProcedureCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"PotentialRequestedProcedureCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def PotentialReasonsForProcedureCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"PotentialReasonsForProcedureCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def ContraindicationsCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"ContraindicationsCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def PredecessorProtocolSequence(self, value: Optional[List[PredecessorProtocolSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"PredecessorProtocolSequence must be a list of PredecessorProtocolSequenceItem objects")
        else:
    ...
    def add_PredecessorProtocol(self, item: PredecessorProtocolSequenceItem):
        if not isinstance(item, PredecessorProtocolSequenceItem):
            raise ValueError(f"Item must be an instance of PredecessorProtocolSequenceItem")
    ...
    def InstructionSequence(self, value: Optional[List[InstructionSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"InstructionSequence must be a list of InstructionSequenceItem objects")
        else:
    ...
    def add_Instruction(self, item: InstructionSequenceItem):
        if not isinstance(item, InstructionSequenceItem):
            raise ValueError(f"Item must be an instance of InstructionSequenceItem")
    ...
    def PatientPositioningInstructionSequence(self, value: Optional[List[PatientPositioningInstructionSequenceItem]]):
        if value is None:
            ...
            raise ValueError(
                f"PatientPositioningInstructionSequence must be a list of PatientPositioningInstructionSequenceItem objects"
            )
        else:
    ...
    def add_PatientPositioningInstruction(self, item: PatientPositioningInstructionSequenceItem):
        if not isinstance(item, PatientPositioningInstructionSequenceItem):
            raise ValueError(f"Item must be an instance of PatientPositioningInstructionSequenceItem")
    ...
    def PositioningMethodCodeSequence(self, value: Optional[List[CodeSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"PositioningMethodCodeSequence must be a list of CodeSequenceItem objects")
        else:
    ...
    def PositioningLandmarkSequence(self, value: Optional[List[PositioningLandmarkSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"PositioningLandmarkSequence must be a list of PositioningLandmarkSequenceItem objects")
        else:
    ...
    def add_PositioningLandmark(self, item: PositioningLandmarkSequenceItem):
        if not isinstance(item, PositioningLandmarkSequenceItem):
            raise ValueError(f"Item must be an instance of PositioningLandmarkSequenceItem")
    ...
    def AcquisitionProtocolElementSequence(self, value: Optional[List[AcquisitionProtocolElementSequenceItem]]):
        if value is None:
            ...
            raise ValueError(
                f"AcquisitionProtocolElementSequence must be a list of AcquisitionProtocolElementSequenceItem objects"
            )
        else:
    ...
    def add_AcquisitionProtocolElement(self, item: AcquisitionProtocolElementSequenceItem):
        if not isinstance(item, AcquisitionProtocolElementSequenceItem):
            raise ValueError(f"Item must be an instance of AcquisitionProtocolElementSequenceItem")
    ...
    def ReconstructionProtocolElementSequence(self, value: Optional[List[ReconstructionProtocolElementSequenceItem]]):
        if value is None:
            ...
            raise ValueError(
                f"ReconstructionProtocolElementSequence must be a list of ReconstructionProtocolElementSequenceItem objects"
            )
        else:
    ...
    def add_ReconstructionProtocolElement(self, item: ReconstructionProtocolElementSequenceItem):
        if not isinstance(item, ReconstructionProtocolElementSequenceItem):
            raise ValueError(f"Item must be an instance of ReconstructionProtocolElementSequenceItem")
    ...
    def StorageProtocolElementSequence(self, value: Optional[List[StorageProtocolElementSequenceItem]]):
        if value is None:
            ...
            raise ValueError(f"StorageProtocolElementSequence must be a list of StorageProtocolElementSequenceItem objects")
        else:
    ...
    def add_StorageProtocolElement(self, item: StorageProtocolElementSequenceItem):
        if not isinstance(item, StorageProtocolElementSequenceItem):
            raise ValueError(f"Item must be an instance of StorageProtocolElementSequenceItem")
