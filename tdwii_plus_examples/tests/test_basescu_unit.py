...
class TestBaseSCU(unittest.TestCase):
    ...
    def test_init(
        ...
        with patch.object(BaseSCU, '_add_requested_context') as mock_add_requested_context:
            ...
            self.test_logger.info("Test init with calling_ae_title=%s, called_ip=%s, called_port=%s, called_ae_title=%s",
                                  calling_ae_title, called_ip, called_port, called_ae_title)
    ...
    @parameterized.expand([
        ...
        (
            [MagicMock(abstract_syntax='1.2.840.10008.1.1'), MagicMock(abstract_syntax='1.2.840.10008.1.2')],
            [MagicMock(abstract_syntax='1.2.840.10008.1.1'), MagicMock(abstract_syntax='1.2.840.10008.1.2')],
            True,
            None
        ),
    ...
    @parameterized.expand([
        ("with_verification", [UID('1.2.840.10008.1.1')], "[Verification SOP Class]"),
    ...
    def test_verify_context_warning(self, name, accepted_sop_classes, expected_transfer_syntax, mock_handle_response):
        ...
        with patch('tdwii_plus_examples.basescu.BaseSCU._associate', side_effect=ContextWarning(
            ...
            self.scu_logger.debug(f"Starting test_verify_context_warning_{name}")
